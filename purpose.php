...
<div class="container-fluid">
    ...
    <p class="text-center">
        MCFB’s Vision: Farmers experience high quality livelihoods by growing world class products
        that support vibrant, healthy, and sustainable farms and communities.
    </p>
    <p class="text-center">
        MCFB's Mission: We help local farmers be successful.
    </p>
    <p class="text-center">
        MCFB's Values: MCFB believes that healthier, happier, and more prosperous farming
