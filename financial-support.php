...
<div class="container-fluid">
    ...
    <p>MCFB provides financial support to organizations that teach and train future and current farmers. A list of currently supported organizations is below. MCFB entertains requests for organizational support on an on-going basis. If you would like to request support, please <a href="contact.php">Contact Us</a>.</p>
    <ul>
